use aqueducts_schemas::{DeltaWriteMode, ReplaceCondition};
use datafusion::dataframe::DataFrame;
use datafusion::execution::context::SessionContext;
use deltalake::{arrow::datatypes::Schema, protocol::SaveMode, DeltaOps, DeltaTable};
use std::sync::Arc;
...
async fn create_delta_table(
    ...
    // Use SaveMode::Ignore to handle both existing and non-existing tables
    // This works consistently across local filesystem and object stores
